...
@section('styles')
    ...
    <style>
        ...
        @media (max-width: 768px) {
            .ponto-titulo { font-size: 1.5rem; }
            .ponto-meta { grid-template-columns: 1fr; }
                ...
                <div class="ponto-info">
                    ...
                    @if(($ponto->badge ?? null) || ($ponto->promocao ?? false))
                        <div class="ponto-badges">
                            @if($ponto->badge)<span class="badge">{{ $ponto->badge }}</span>@endif
                            @if($ponto->promocao)<span class="badge badge-promocao">Promoção</span>@endif
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="ponto-conteudo">
                ...
                <div class="galeria">
                    <div class="galeria-item">
                        <img src="{{ $ponto->imagem }}" alt="{{ $ponto->nome }} - Vista"
                ...
                @if(isset($ponto) && $ponto->lat && $ponto->lng)
                    try {
                        ...
                        L.marker([{{ $ponto->lat }}, {{ $ponto->lng }}])
                            .addTo(map)
                            .bindPopup('<b>{{ addslashes($ponto->nome) }}</b><br>{{ addslashes($ponto->localizacao) }}')
                            .openPopup();
