...
<head>
  ...
  <title>Cantina Pastasciutta</title>
  ...
  <main class="grid-container">
    ...
    <div class="conteudo">
      ...
      <section class="destino">
        <h1>Cantina Pastasciutta</h1>
        <img src="../IMAGENS/Banner_ Cantina Pastasciutta.png" alt="Restaurante Terral" />
...
<div class="info-localizacao">
    <p>📍 Av. Borges de Medeiros, 2083 - Centro, Gramado - RS </p>
    <p>📞Telefone: +55 543286-2131</p>
    <p>🕒Horário de funcionamento: Segunda a Domingo das 11:30 ás  23:30 horas.   </p>
</div>
        <h2> Sobre</h2>
        <p>A Cantina Pastasciutta, em Gramado, é um restaurante tradicional que oferece o melhor da culinária italiana. Com um ambiente acolhedor e rústico, o restaurante se destaca por suas massas artesanais e pratos saborosos, preparados com ingredientes frescos e de alta qualidade. A Cantina Pastasciutta proporciona uma experiência gastronômica autêntica, ideal para quem deseja saborear receitas italianas em um ambiente encantador em meio à charmosa cidade de Gramado.</p>  
      <!-- Galeria de imagens secundárias -->
      <section class="imagens-secundarias">
        <img src="../IMAGENS/Prato1-Cantina Pastasciutta.png" alt="foto 1">
        <img src="../IMAGENS/Prato2-Cantina Pastasciutta.png" alt="foto 2">
      </section>
      ...
      <section class="comentarios">
        ...
        <div class="comentario">
            <h3>Celso Nagori <span>★★★★★</span></h3>
            </p>A experiência na Cantina Pastasciutta foi incrível! As massas são frescas e deliciosas, com sabores autênticos da culinária italiana. O ambiente acolhedor e o atendimento atencioso tornam a refeição ainda mais especial. Sem dúvida, uma excelente escolha em Gramado!</p>    
        </section>
