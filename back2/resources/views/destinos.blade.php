            ...
            <div class="instrucoes">
                ...
                <ol class="instrucoes-lista">
                    <li class="instrucoes-item">
                        <strong>Escolha uma categoria:</strong> Selecione entre hotéis, restaurantes ou pontos turísticos
                        com base no seu interesse atual.
                    </li>
                    <li class="instrucoes-item">
                        <strong>Explore as opções:</strong> Veja as diversas opções disponíveis, filtre por avaliações,
                        preço, localização ou outros critérios relevantes.
                    </li>
                    <li class="instrucoes-item">
                        <strong>Faça reservas ou planeje visitas:</strong> Para hotéis, faça reservas diretamente. Para
                        restaurantes, verifique disponibilidade ou faça reservas. Para pontos turísticos, planeje sua
                        visita.
                    </li>
                    <li class="instrucoes-item">
                        <strong>Compartilhe sua experiência:</strong> Após sua visita, avalie e compartilhe sua experiência
                        para ajudar outros viajantes e acumular pontos para descontos futuros.
                    </li>
                </ol>
            </div>
    </main>
