...
<head>
    ...
    <title>Pontos Turísticos no Rio de Janeiro</title>
...
<body>
    ...
    <div class="apresetacao">
        <h1>Pontos Turísticos no Rio de Janeiro</h1>
    </div>
    ...
    <section class="conteudo-geral">
        ...
        <div class="turismo">
            <img src="../../IMAGENS/Copacabana.png" alt="Copacabana">
            <div class="info">
                <h2>Praia de Copacabana</h2>
                <p>      Uma das praias mais famosas do mundo, Copacabana é sinônimo de beleza natural, vida vibrante e cultura carioca, sendo um local de lazer tanto para moradores quanto para turistas.</p>
            </div>
        </div>

        <div class="turismo">
            <img src="../../IMAGENS/Banner_Cristo_Redentor.png" alt="Cristo Redentor">
            <div class="info">
                <h2>Cristo Redentor</h2>
                <p>       Uma das Sete Maravilhas do Mundo Moderno, essa icônica estátua de Jesus Cristo no topo do Corcovado oferece uma vista panorâmica deslumbrante da cidade.</p>
            </div>
        </div>

        <div class="turismo">
            <img src="../../IMAGENS/pao_de_acucar_principal.jpg" alt="Pão de açúcar">
            <div class="info">
                <h2>Pão de Açúcar</h2>
                <p>      Um dos cartões-postais mais famosos do Rio, o Pão de Açúcar proporciona uma vista incrível da cidade, especialmente ao subir de bondinho até o topo.</p>
            </div>
        </div>
    </section>
