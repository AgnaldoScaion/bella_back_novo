  ...
  <main class="grid-container">
    ...
    <div class="conteudo">
      ...
      <section class="destino">
        <h1>Catedral da Sé</h1>
        <img src="../../IMAGENS/Catedral da Sé.png" alt="Ibirapuera Park" />
    ...
    <div class="info-localizacao">
        <p>📍 Praça da Sé, s/n, Sé, São Paulo - SP, 01001-000, Brasil.</p>
    </div>
        <h2> Sobre</h2>
        <p>
        A Catedral da Sé, em São Paulo, é um dos marcos históricos e arquitetônicos mais importantes da cidade. Construída em estilo neogótico, com impressionantes vitrais e uma grandiosa cúpula renascentista, a igreja se destaca no coração da capital paulista. Localizada na Praça da Sé, é um dos principais cartões-postais de São Paulo, sendo um local de fé, cultura e turismo. Além de sua beleza, a catedral abriga uma cripta subterrânea onde estão sepultadas figuras importantes da história brasileira.        
        <p>   
        </section>
  
      <!-- Galeria de imagens secundárias -->
      <section class="imagens-secundarias">
        <img src="../../IMAGENS/Foto1_Catedral da Sé.png" alt="Catedral da Sé">
        <img src="../../IMAGENS/Foto2_Catedral da Sé.png" alt="Catedral da Sé">
      </section>
      ...
      <section class="comentarios">
        ...
        <div class="comentario">
            ...
            </p>A Catedral da Sé é impressionante! A arquitetura neogótica, os vitrais coloridos e a grandiosidade do espaço criam um ambiente magnífico. Além disso, a cripta subterrânea é uma parte fascinante da visita.</p>  
          </section>
