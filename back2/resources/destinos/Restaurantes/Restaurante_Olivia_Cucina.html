  ...
  <main class="grid-container">
    ...
    <div class="conteudo">
      ...
      <section class="destino">
        <h1>Olivia Cucina</h1>
        <img src="../IMAGENS/Banner_  Olivia Cucina.png" alt="Restaurante Terral" />
...
<div class="info-localizacao">
    <p>📍Al. Annita Hoepcke da Silva, 70 - Centro, Florianópolis - SC </p>
    <p>📞Telefone:   +55 4899194-1808</p>
    <p>🕒Horário de funcionamento: Segunda a Domingo das 11:00 ás  22:30 horas. </p>
</div>
        <h2> Sobre</h2>
      ...
      <section class="imagens-secundarias">
        <img src="../IMAGENS/Prato1-Olivia Cucina.png" alt="foto 1">
        <img src="../IMAGENS/Prato2-Olivia Cucina.png" alt="foto 2">
      </section>
      ...
      <section class="comentarios">
        ...
        <div class="comentario">
            ...
            </p>A experiência no Olivia Cucina foi impecável! Os pratos são deliciosos, com massas frescas e ingredientes de altíssima qualidade. O ambiente é acolhedor e sofisticado, e o atendimento é excepcional. Sem dúvida, uma das melhores opções de culinária italiana em Florianópolis!  </p>    
        </section>
