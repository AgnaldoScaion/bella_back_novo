    ...
    <section class="section" id="features">
        ...
        <div class="features-grid">
            <div class="feature-card">
                ...
                <p>Nosso sistema mostra automaticamente os melhores restaurantes e pontos turísticos próximos ao seu hotel.</p>
            </div>
            <div class="feature-card">
        ...
        <div class="bonus-system">
            <div class="how-it-works">
                ...
                <div class="example-card">
                    ...
                    <p style="font-family: monospace; background: var(--text-light); padding: 1rem; border-radius: 4px; margin-top: 1rem;">
                        (5 × 5) + (4 × 10) + (3 × 3) = 25 + 40 + 9 = <strong style="color: var(--primary-color);">74 pontos</strong>
                    </p>
                </div>
            </div>
        </div>
